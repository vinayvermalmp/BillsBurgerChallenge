...
//        System.out.println(tim);
        ...
        System.out.println("Status for Current Age = " + currentAgeStream.summaryStatistics());
        ...
        List<Student> longTimeLearners = Arrays.stream(students)
                ...
                .filter(s -> !s.hasProgrammingExperience())
                .limit(5)
                .toList(); // return as unmodifiablelist
        ...
        var longTimeLearnersArray= Arrays.stream(students)
                ...
                .filter(s -> !s.hasProgrammingExperience())
                .limit(5)
              //  .toArray(); // return an array of object to use you should cast the obj to array
                .toArray(Student[]::new); // this will return array of students
