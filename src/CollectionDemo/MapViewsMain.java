...
import CollectionDemo.contactDemo.Contact;
import CollectionDemo.contactDemo.ContactData;
...
public class MapViewsMain {
    public static void main(String[] args) {
        ...
        //Set<Contact> values = (Set<Contact>) contacts.values();

        Set<String> copyOfKeys = new TreeSet<>(contacts.keySet());
        System.out.println(copyOfKeys);

        if (contacts.containsKey("Linus Van Pelt")) {
            System.out.println("Linus And I go back");
        }
        ...
        keysView.removeAll(List.of("Linus Van Pelt, Charlie Brown, Robin Hood, Mickey Mouse"));
        System.out.println(keysView);
        contacts.forEach((k, v) -> System.out.println(v));
