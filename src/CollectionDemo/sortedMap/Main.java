package CollectionDemo.sortedMap;
...
//        week2Purchase.forEach((key, value) -> System.out.println(key + ": " + value));
        ...
        displayStatus(1, week1Purchase);
        displayStatus(2, week2Purchase);
    ...
    private static void displayStatus(int period, Map<LocalDate, List<Purchase>> periodData){
        System.out.println("-------------------------------------------");
